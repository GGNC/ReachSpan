export class Character {
    constructor() {
        ...
        this.description = getRandomDescription(this.behavior, this.role, this.looks, this.background, this.backstory);
        this.credit = 3;
        this.items = [
            {id: 0, name : "Suit" , tag : "Gear , example " , clockType : 1 , clockStage : 0},
        ];
        this.stats = getStats();
